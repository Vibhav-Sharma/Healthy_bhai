...
class PatientDashboard extends StatefulWidget {
  ...
  PatientDashboard({super.key, required this.patientId});
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text('ID: ${widget.patientId}', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.6))),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(color: Color(0xffF59E0B).withOpacity(0.3), blurRadius: 10, offset: Offset(0, 4))],
                      ),
                      child: Row(
                        children: [
                          Container(
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Text('View All', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Color(0xffDC2626))),
                    ),
                  ],
                ),
                ...
                if (_recentActivity.isEmpty)
                  ...
                  ...(_recentActivity.map((event) {
                    ...
                    if (eventText.contains('Upload')) { icon = Icons.upload_file; iconColor = Colors.green[600]!; iconBg = Colors.green.withValues(alpha: 0.1)!; }
                    else if (eventText.contains('AI')) { icon = Icons.smart_toy; iconColor = Colors.purple[600]!; iconBg = Colors.purple.withValues(alpha: 0.1)!; }
                    else if (eventText.contains('Note')) { icon = Icons.note; iconColor = Colors.orange[600]!; iconBg = Colors.orange.withValues(alpha: 0.1)!; }
                    else if (eventText.contains('medicine') || eventText.contains('prescription') || eventText.contains('extracted')) { icon = Icons.medication; iconColor = Colors.teal[600]!; iconBg = Colors.teal.withValues(alpha: 0.1)!; }
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.02), blurRadius: 6, offset: Offset(0, -4))],
              ),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.02), blurRadius: 6, offset: Offset(0, -1))],
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Container(width: 40, height: 40, decoration: BoxDecoration(color: Colors.red.withValues(alpha: 0.1), shape: BoxShape.circle), child: Icon(icon, color: Color(0xffDC2626), size: 24)),
            Spacer(),
            Text(title, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Color(0xffDC2626))),
            SizedBox(height: 4),
            Text(subtitle, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.6), height: 1.3), maxLines: 2, overflow: TextOverflow.ellipsis),
          ],
        ),
      ),
    );
  ...
  Widget _buildNavItem(IconData icon, String label, int index) {
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          Icon(icon, color: isActive ? Color(0xffDC2626) : Colors.grey[400], size: 24),
          SizedBox(height: 6),
          Text(label, style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1, color: isActive ? Color(0xffDC2626) : Colors.grey[400])),
        ],
      ),
    );
  }
